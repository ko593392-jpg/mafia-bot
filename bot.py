...
def get_game_markup(n):
    """Tugmalar dizayni. n - ishtirokchilar soni"""
    markup = types.InlineKeyboardMarkup()
    # Har bir tugma data qismida o'yin hajmini (n) saqlaydi
    markup.row(
    ...
    try:
        ...
        for opt in game_types:
            ...
            results.append(types.InlineQueryResultArticle(
                ...
                reply_markup=get_game_markup(n) # Tugmalarga n sonini uzatamiz
            ))
...
def handle_play(call):
    ...
    move_key = data[1]       # rock, scissors, paper
    total_needed = int(data[2]) # Tugmadan kelgan aniq son (2, 3, 4 yoki 5)
    ...
    # Bitta odam faqat bir marta tanlay oladi
    ...
    if current_players < total_needed:
        ...
        # O'yin tugadi, xotirani bo'shatamiz
        if msg_id in active_games:
            del active_games[msg_id]

# Botni xatosiz yurgizish
